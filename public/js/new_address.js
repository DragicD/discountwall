...
$(document).ready(function(){
    ...
    $( "#new_city_button" ).click(function(){
        //var div_city = $(".multi_address_div").clone().prop('class', 'multi_address_div'+j );
        var div_city ='<div class="multi_address_div'+j+'"> <div class="form-group{{ $errors->has("city") ? " has-error" : "" }}"> <label class="col-md-4 control-label">City</label> <div class="col-md-6"> <input id = "city_input'+j+'" type="text" class="form-control" name="city">';
        ...
        div_city += '<input type="text" class="form-control" name="address"> </div>';
